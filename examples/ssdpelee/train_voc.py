...
from feature_extractor import CreateMultiBoxHead, CreateMultiBoxHead_self
...
train_data = "/media/hdd/lbl_trainData/share/originVoc/lmdb/VOC2007_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/media/hdd/lbl_trainData/share/originVoc/lmdb/VOC2007_test_lmdb"
...
job_name = "vehiclePeroson"
# The name of the model. Modify it if you want.
model_name = "ssd304p_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "/media/hdd/lbl_trainData/dataBase/ssdpelee_fp16/work/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "/media/hdd/lbl_trainData/dataBase/ssdpelee_fp16/work/models/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "/media/hdd/lbl_trainData/dataBase/ssdpelee_fp16/work/jobs/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "/media/hdd/lbl_trainData/dataBase/ssdpelee_fp16/work/results/VOC2007/{}/Main".format(os.environ['HOME'], job_name)
...
# Stores the test image names and sizes. Created by data/VOC0712/create_list.sh
name_size_file = "/media/hdd/lbl_trainData/share/originVoc/test_name_size.txt"
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
pretrain_model = "/media/hdd/lbl_trainData/modelZoo/pelee_304x304_acc7637.caffemodel"
# Stores LabelMapItem.
...
aspect_ratios = [[2,3,4], [2,3,4], [2,3,4], [2,3,4], [2,3], []]
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [oneStep,20000+ 2*oneStep,20000+ 3*oneStep],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 20000+4*oneStep+2,
    'snapshot': oneStep/2,
    'display': 100,
    'average_loss': 100,
    'type': "SGD",
...
mbox_layers = CreateMultiBoxHead_self(net, data_layer='data', from_layers=mbox_source_layers,
...
with open(job_file, 'w') as f:
  f.write('cd {}\n'.format(caffe_root))
  f.write('/media/hdd/lbl_trainData/git/caffe_build_/build/tools/caffe train \\\n')
  f.write('--solver="{}" \\\n'.format(solver_file))
