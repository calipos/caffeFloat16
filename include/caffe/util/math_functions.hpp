...
void caffe_gpu_axpy_half(const int N, __half alpha, const __half* X, __half* Y);
void caffe_gpu_scal_half(const int N, __half alpha, __half *X);
void caffe_gpu_axpby_half(const int N, const __half alpha, const float* X, const __half beta, float* Y);
